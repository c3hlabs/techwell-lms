 ...
 */
router.put('/:id/invalidate', authenticate, authorize('SUPER_ADMIN', 'ADMIN'), async (req, res, next) => {
    try {
 ...
 * @access  Private/Admin
 */
router.get('/admin/settings', authenticate, authorize('SUPER_ADMIN', 'ADMIN'), async (req, res, next) => {
    try {
        let settings = await prisma.certificateSettings.findFirst({
            where: { instituteId: 'default' }
        });
 ...
 * @access  Private/Admin
 */
router.put('/admin/settings', authenticate, authorize('SUPER_ADMIN', 'ADMIN'), async (req, res, next) => {
    try {
        const {
            prefix,
            yearInId,
 ...
 * @access  Private/Admin
 */
router.get('/admin/templates', authenticate, authorize('SUPER_ADMIN', 'ADMIN'), async (req, res, next) => {
    try {
 ...
 * @access  Private/Admin
 */
router.post('/admin/templates', authenticate, authorize('SUPER_ADMIN', 'ADMIN'), async (req, res, next) => {
    try {
 ...
 * @access  Private/Admin
 */
router.put('/admin/templates/:id', authenticate, authorize('SUPER_ADMIN', 'ADMIN'), async (req, res, next) => {
    try {
 ...
 * @access  Private/Admin
 */
router.delete('/admin/templates/:id', authenticate, authorize('SUPER_ADMIN', 'ADMIN'), async (req, res, next) => {
    try {
