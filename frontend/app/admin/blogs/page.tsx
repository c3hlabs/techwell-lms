...
export default function BlogManagerPage() {
    ...
    const handleCreateOpen = () => {
        setFormData({ id: '', title: '', content: '', excerpt: '', status: 'DRAFT', tags: '', coverImage: '' })
        setShowModal(true)
    }
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage articles, news, and updates.</p>
                </div>
                                ...
                                <TableRow key={blog.id}>
                                    ...
                                    <TableCell className="text-right">
                                        <div className="flex justify-end gap-2">
                                            <Button variant="ghost" size="sm" onClick={() => handleEditOpen(blog)}>
            ...
            <Dialog open={showModal} onOpenChange={setShowModal}>
                <DialogContent className="max-w-3xl">
                    <DialogHeader>
                        <DialogTitle>{formData.id ? 'Edit Post' : 'New Blog Post'}</DialogTitle>
                    </DialogHeader>
